...
function getTestCases() {
    ...
    function addNewTestCase( DateString, UTCDate, LocalDate) {
        ...
        array[item++] = Assert.expectEq(  DateString+".getTime()",             true, UTCDate.value ==       DateCase.getTime() );
        array[item++] = Assert.expectEq(  DateString+".valueOf()",             true, UTCDate.value ==       DateCase.valueOf() );
    
        array[item++] = Assert.expectEq(  DateString+".getUTCFullYear()",      true, UTCDate.year ==    DateCase.getUTCFullYear() );
        array[item++] = Assert.expectEq(  DateString+".getUTCMonth()",         true, UTCDate.month ==  DateCase.getUTCMonth() );
        array[item++] = Assert.expectEq(  DateString+".getUTCDate()",          true, UTCDate.date ==   DateCase.getUTCDate() );
        array[item++] = Assert.expectEq(  DateString+".getUTCDay()",           true, UTCDate.day ==    DateCase.getUTCDay() );
        array[item++] = Assert.expectEq(  DateString+".getUTCHours()",         true, UTCDate.hours ==  DateCase.getUTCHours() );
        array[item++] = Assert.expectEq(  DateString+".getUTCMinutes()",       true, UTCDate.minutes == DateCase.getUTCMinutes() );
        array[item++] = Assert.expectEq(  DateString+".getUTCSeconds()",       true, UTCDate.seconds == DateCase.getUTCSeconds() );
        array[item++] = Assert.expectEq(  DateString+".getUTCMilliseconds()",  true, UTCDate.ms ==     DateCase.getUTCMilliseconds() );
    
        array[item++] = Assert.expectEq(  DateString+".getFullYear()",         true, LocalDate.year ==       DateCase.getFullYear() );
        array[item++] = Assert.expectEq(  DateString+".getMonth()",            true, LocalDate.month ==      DateCase.getMonth() );
        array[item++] = Assert.expectEq(  DateString+".getDate()",             true, LocalDate.date ==       DateCase.getDate() );
        array[item++] = Assert.expectEq(  DateString+".getDay()",              true, LocalDate.day ==        DateCase.getDay() );
        array[item++] = Assert.expectEq(  DateString+".getHours()",            true, LocalDate.hours ==      DateCase.getHours() );
        array[item++] = Assert.expectEq(  DateString+".getMinutes()",          true, LocalDate.minutes ==    DateCase.getMinutes() );
        array[item++] = Assert.expectEq(  DateString+".getSeconds()",          true, LocalDate.seconds ==    DateCase.getSeconds() );
        array[item++] = Assert.expectEq(  DateString+".getMilliseconds()",     true, LocalDate.ms ==         DateCase.getMilliseconds() );
        ...
        if (!true) {
            ...
            array[item++]  =Assert.expectEq(DateString+".toString=Object.prototype.toString;"+DateString+".toString()","[object Date]", DateCase.toString() );
        }
    }
